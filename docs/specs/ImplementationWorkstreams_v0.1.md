...
_(Draft v0.1. This narrower scope (foundations + J5) validates the riskiest user journey first. After cold-start works, proceed to V1 full loop, then V2–V6. Grounded in PRD v0.4, Architecture v0.1, and Interface Contracts.)_
